                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                ...
                                <div class="accordion-body">
                                    ...
                                    memberikan layanan data dengan batas quota ataupun penurunan kecepatan pada batas
                                    quota
                                    penggunaan tertentu kepada seluruh pelanggan, agar pelanggan memiliki pengalaman
                                    dalam
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingSeven">
                                <button class="accordion-button collapsed" type="button" data-mdb-toggle="collapse"
                                    data-mdb-target="#collapseSeven" aria-expanded="false"
                                    aria-controls="collapseSeven">
                                    Bagaimana cara melakukan pembayaran Tagihan secara virtual?
                                </button>
                            </h2>
                            <div id="collapseSeven" class="accordion-collapse collapse"
                                aria-labelledby="headingSeven" data-mdb-parent="#accordionExample">
                                <div class="accordion-body">
                                    Pembayaran tagihan secara virtual dapat dilakukan ketika anda sudah menerima pesan
                                    dari
                                    admin yang berisi link untuk melakukan pembayaran secara virtual (E-Wallet,
                                    M-banking,
                                    ATM, dan lainnya).
                                </div>
                            </div>
